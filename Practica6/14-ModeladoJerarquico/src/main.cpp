...
void applicationLoop() {
	...
	while (psi) {
		...
		glm::mat4 matrixs7 = glm::translate(matrix7, glm::vec3(0.3f, 0.0f, 0.0f));
				...
				//antebrazo
				glm::mat4 matrix6 = glm::rotate(matrixs7, 0.3f, glm::vec3(0.0f, 0.0f, -1.0f));
				matrix6 = glm::translate(matrix6, glm::vec3(0.0f, -0.2f, 0.0f));
						//muñeca
						glm::mat4 matrixs9 = glm::translate(matrix6, glm::vec3(0.0f, -0.2f, 0.0f));
						matrixs9 = glm::rotate(matrixs9, rot6, glm::vec3(0.0f, 0.0f, 1.0f));
						matrixs9 = glm::rotate(matrixs9, rot7, glm::vec3(0.0f, 1.0f, 0.0f));
								//mano
								glm::mat4 matrix8 = glm::translate(matrixs9, glm::vec3(0.0f, -0.075f, 0.0f));
								matrix8 = glm::scale(matrix8, glm::vec3(0.05, 0.15, 0.1));
				...
				matrix6 = glm::scale(matrix6, glm::vec3(0.1, 0.4, 0.2));
		...
		//para arreglar figura que ya teniamos       
